...
expName = 'Pattern_2'  # from the Builder filename that created this script
expInfo = {
    'participant': 'test',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/strix_uralensis/Documents/Experiment/research/game2.py',
...
# Images
slf_img = ['images/slf21.png', 'images/slf22.png', 'images/slf23.png']
obs_img = ['images/obs21.png', 'images/obs22.png', 'images/obs23.png']
...
out_name = f'subj_{participant}_game2_{get_current_time:%y%m%d%H%M}' 
...
BlockLoop = data.TrialHandler(
    ...
    trialList=data.importConditions('sequences/game2/condition2.xlsx'),
...
for thisBlockLoop in BlockLoop:
    ...
    ObsSequence = data.TrialHandler(
        nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('sequences/game2/' + obs_file),
    ...
    SlfSequence = data.TrialHandler(
        nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('sequences/game2/' + slf_file),
    ...
    TestSequence = data.TrialHandler(
        nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('sequences/game2/' + test_file), # ok
