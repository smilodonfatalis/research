...
expName = 'Pattern_4'  # from the Builder filename that created this script
expInfo = {
    'participant': 'test',
}
...
# Images
slf_img = ['images/slf41.png', 'images/slf42.png', 'images/slf43.png']
obs_img = ['images/obs41.png', 'images/obs42.png', 'images/obs43.png']
