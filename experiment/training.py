...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/strix_uralensis/Documents/Experiment/research/game1.py',
...
# Images
slf_img = ['images/slfT1.png', 'images/slfT2.png', 'images/slfT3.png']
obs_img = ['images/obsT1.png', 'images/obsT2.png', 'images/obsT3.png']
...
out_name = f'subj_{participant}_training_{get_current_time:%y%m%d%H%M}' 
...
BlockLoop = data.TrialHandler(
    ...
    trialList=data.importConditions('sequences/training/conditionT.xlsx'),
...
for thisBlockLoop in BlockLoop:
    ...
    SlfSequence = data.TrialHandler(
        nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('sequences/training/' + slf_file),
    ...
    ObsSequence = data.TrialHandler(
        nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('sequences/training/' + obs_file),
    ...
    TestSequence = data.TrialHandler(
        nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('sequences/training/' + test_file), # ok
