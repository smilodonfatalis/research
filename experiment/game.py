...
# Images
slf_img = ['images/slf11.png', 'images/slf12.png', 'images/slf13.png']
obs_img = ['images/obs11.png', 'images/obs12.png', 'images/obs13.png']
...
for thisBlockLoop in BlockLoop:
        ...
        for thisSlfSkip in SlfSkip:
            ...
            while continueRoutine:
                ...
                if SLF_CONF_FIX.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > SLF_CONF_FIX.tStartRefresh + FEEDBACK_TIME-frameTolerance:
                        # keep track of stop time/frame for later
    ...
    for thisObsSequence in ObsSequence:
        ...
        obs_data_table.append([block_cnt, through_game_cnt, obs_seq_type, obs_trial_cnt, 
                               ...
                               ovs_conf_pat, obs_conf, obs_acc, obs_reward, 
